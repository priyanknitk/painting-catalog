    ...
    >
      ...
      >
        <div className="relative">
          ...
          <button
            onClick={onClose}
            className="absolute top-6 right-6 z-10 bg-gray-900/80 backdrop-blur-sm text-white rounded-full p-3 hover:bg-gray-900 transition-all duration-200 hover:scale-110 shadow-lg border border-white/20"
          >
